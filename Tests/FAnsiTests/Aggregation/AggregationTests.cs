...
*/
        ...
        public void Test_PivotOnlyCount(DatabaseType type)
        {
            ...
            lines.Add(new CustomLine("count(*) as MyCount,", QueryComponent.QueryTimeColumn) { Role = CustomLineRole.CountFunction });
            lines.Add(new CustomLine("Category,", QueryComponent.QueryTimeColumn));
            lines.Add(new CustomLine("EventDate", QueryComponent.QueryTimeColumn){Role = CustomLineRole.Pivot});
            ...
            using (var con = svr.GetConnection())
            {
                ...
                /*
                    Category	    2001-01-01 00:00:00.0000000	2002-01-01 00:00:00.0000000	2002-02-01 00:00:00.0000000	2002-03-02 00:00:00.0000000	2003-01-01 00:00:00.0000000	2003-04-02 00:00:00.0000000	2005-01-01 00:00:00.0000000	2001-01-02 00:00:00.0000000
