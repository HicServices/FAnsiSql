...
| MySqlConnector | [GitHub](https://github.com/mysql-net/MySqlConnector) | [1.2.1](https://www.nuget.org/packages/MySqlConnector/1.2.1) | [MIT](https://github.com/mysql-net/MySqlConnector/blob/master/LICENSE) | Enables interaction with MySql databases |  |
| Oracle.ManagedDataAccess.Core  | Closed Source | [2.19.100](https://www.nuget.org/packages/Oracle.ManagedDataAccess.Core/2.19.100) | [OTNLA](https://www.oracle.com/downloads/licenses/distribution-license.html) | Enables interaction with Oracle databases |
...
| Npgsql | [GitHub](https://github.com/npgsql/npgsql) | [5.0.1.1](https://www.nuget.org/packages/Npgsql/5.0.1.1) | [PostgreSQL](https://github.com/npgsql/npgsql/blob/dev/LICENSE)| Enables interaction with Postgres databases  | |
