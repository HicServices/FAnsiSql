...
| MySqlConnector | [GitHub](https://github.com/mysql-net/MySqlConnector) | [1.3.7](https://www.nuget.org/packages/MySqlConnector/1.3.7) | [MIT](https://github.com/mysql-net/MySqlConnector/blob/master/LICENSE) | Enables interaction with MySql databases |  |
...
| Npgsql | [GitHub](https://github.com/npgsql/npgsql) | [5.0.4](https://www.nuget.org/packages/Npgsql/5.0.4) | [PostgreSQL](https://github.com/npgsql/npgsql/blob/dev/LICENSE)| Enables interaction with Postgres databases  | |
